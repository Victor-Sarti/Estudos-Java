...
public class ExListaEsporteJFrame extends JFrame 
	implements ListSelectionListener, ActionListener{  
	JLabel l1;  JTextField t1;    JButton bquant,bindice,bclear,bColor;
	JList lista; // Criando objeto Lista	
	DefaultListModel listModel; 
	public static void main(String args[]){
		new   ExListaEsporteJFrame();
	}
	public  ExListaEsporteJFrame ()	{
		setSize(400,300);
		setTitle("Usando do JList");        
		l1 = criarRotulo("Sem selecao"); 
		t1 = criarTexto();        		
		setLayout(new GridLayout(7,1)); //Criando um Layout do tipo Grid     		
		String esportes[] = {"Skate", "Rugby", "Futboll", "Volei" };
		...
		bColor = criarBotao("Cor do Texto");
